...
describe("disposable extensions", () => {
  describe("Async/DisposableStack extensions", () => {
    ...
    describe(".transaction()", () => {
      ...
      it("should run transaction. async", async () => {
        const { disposables, dispose } = createAsyncDisposables();
        const stack = await AsyncDisposableStack.transaction((stack) => {
          stack.append(...disposables);
        });
        await expect(dispose(stack)).resolves.toBe(true);
      });

      it("should revert transaction. sync", () => {
      ...
      it("should revert transaction. async", async () => {
        const disposable = jest.fn();
        await expect(
      ...
      it("should suppress dispose error. sync", () => {
        const disposable = jest.fn(() => {
      ...
      it("should suppress dispose error. async", async () => {
    ...
    describe("Async/DisposableStack.stamper", () => {
      it("should store Async/DisposableStack and describe new dispose method. sync", () => {
      ...
      it("should store Async/DisposableStack and describe new dispose method. async", async () => {
        const dispose = jest.fn();
