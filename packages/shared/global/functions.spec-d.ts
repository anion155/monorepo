...
type AbstractConstructorTests = [
  ...
  Expect<Equal<InferAbstractConstructor<typeof abstract_constructor>["Params"], Params>>,
  Expect<Equal<InferAbstractConstructor<typeof proto_function>, never>>,
];

type ProtoFunctorTests = [
